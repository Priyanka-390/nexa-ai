...
const Utilitysec = () => {
  return (
    <div
      className="xl:pt-40 lg:pt-32 md:pt-20 sm:pt-16 pt-12 relative z-[1] overflow-x-clip"
      id="token"
    >
        ...
        <div className="flex flex-row flex-wrap -mx-3">
          <div className="md:w-1/2 w-full px-3 relative flex max-md:justify-center">
            <img
              src={handimg}
              alt="hand"
              className=" lg:-translate-x-32 mix-blend-overlay "
            />
          </div>
      ...
      <img
        src={rightring}
        alt="right"
        className=" absolute right-0 md:block hidden  top-0"
      />
    </div>
  );
};
