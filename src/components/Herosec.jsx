...
const Herosec = () => {
  return (
    <div className='flex-grow max-sm:py-20 flex justify-center items-center' data-aos="fade-right"  data-aos-delay='3000'>
      ...
      <img src={gradient} alt="g" className=' absolute bottom-0' />
    </div>
  )
}
