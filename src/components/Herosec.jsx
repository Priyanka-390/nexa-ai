...
const Herosec = () => {
  return (
    <div className='flex-grow max-md:py-20 flex  justify-center items-center z-[1]' data-aos="fade-right"  data-aos-delay='3000'>
      ...
      <img src={gradient} alt="g" className=' absolute bottom-[-10%]' />
    </div>
  )
}
